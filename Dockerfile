...
RUN echo 'opal rest -o https://localhost:8443 --user administrator --password  password --method POST "/service/r/packages?manager=gh&name=sib-swiss/dsSwissKnife"' >> /opt/opal/bin/first_run.sh
RUN echo 'opal rest -o https://localhost:8443 --user administrator --password  password --method POST "/service/r/packages?manager=gh&name=sib-swiss/resourcex"' >> /opt/opal/bin/first_run.sh
RUN echo 'opal rest -o https://localhost:8443 --user administrator --password  password --method POST "/service/r/packages?name=DSI"'  >> /opt/opal/bin/first_run.sh
RUN echo 'opal rest -o https://localhost:8443 --user administrator --password  password --method POST "/service/r/packages?manager=gh&name=vanduttran/dsSSCP"'  >> /opt/opal/bin/first_run.sh
RUN echo 'opal rest -o https://localhost:8443 --user administrator --password  password --method POST "/service/r/packages?manager=gh&name=vanduttran/dsSSCPclient"'  >> /opt/opal/bin/first_run.sh
